...
``` {.haskell-ng file="other/bar2.svg" results="output graphics file" exports="both"}
...
``` {.haskell-ng file="other/bar3.svg" results="output graphics file" exports="both"}
...
``` {.haskell-ng file="other/pie.svg" results="output graphics file" exports="both"}
acc0 = List.scanl' (+) 0 vs <> [1]
mids = zipWith (\a0 a1 -> (a0+a1)/2) acc0 (List.drop 1 acc0)
