...
A reproducible build for dataHaskell.

This repository is a reproducable build representing dataHaskell development.

It contains:

-   a [dataframe](https://github.com/mchav/dataframe) example taken from the first kaggle run.
...
# Approximate Current Development State

This snippet represents a current state being developed.

non-reproduction is a bug.
